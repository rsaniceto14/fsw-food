...
-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_restauranId_fkey" FOREIGN KEY ("restauranId") REFERENCES "Restaurant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
