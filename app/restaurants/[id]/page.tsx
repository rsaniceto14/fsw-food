...
const RestaurantPage = async ({ params: { id } }: RestaurantPageProps) => {
  ...
  return (
    <div>
      ...
      {/* <RestaurantDetails restaurant={restaurant} recommendedRestaurants={juices} /> */}
      ...
      <div className="relative z-50 mt-[-1.5rem]  flex items-center justify-between rounded-tl-3xl rounded-tr-3xl bg-white px-5 py-5 pt-5">
        ...
        <div className="text flex items-center gap-[3px] rounded-full bg-foreground px-2 py-[2px] text-white">
